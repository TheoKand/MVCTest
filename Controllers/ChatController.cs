...
namespace MVC_TestBed.Controllers
{
    public class ChatController : Controller
    {
        ...
        /// When argument thisUserLoggedOn is specified, a user logged on
        ...
        /// <param name="userLoggedOff"></param>
        ...
        public ActionResult Index(string user,bool? logOn, bool? logOff, string chatMessage)
        {
            try
            {
                ...
                else
                {
                    ...
                    foreach (MVC_TestBed.Models.ChatModel.ChatUser usr in chatModel.Users)
                    {
